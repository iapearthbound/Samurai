...
enum {
	// charge rate
	BATT_CHARGE_RATE_AC = 0,
	BATT_CHARGE_RATE_USB,
	// charge control
	BATT_CHARGE_FULL_VOLTAGE,
	BATT_CHARGE_FULL_CURRENT,
	BATT_CHARGE_RECHARGE_VOLTAGE,
};
...
// charge control
#define FULL_CHARGE_COND_VOLTAGE_DEFAULT (4000 * 1000)
#define FULL_CHARGE_COND_CURRENT_DEFAULT 91
#ifdef CONFIG_MACH_VICTORY
#define RECHARGE_COND_VOLTAGE_DEFAULT    (4110 * 1000)
#else
#define RECHARGE_COND_VOLTAGE_DEFAULT    (4130 * 1000)
#endif

#ifdef CONFIG_BATTERY_S5PC110_CHARGE_CONTROL
// charge rate
#define CHARGE_RATE_MIN 0
#define CHARGE_RATE_MAX 7
// charge control
#define FULL_CHARGE_COND_VOLTAGE_MAX (4200 * 1000)
#define FULL_CHARGE_COND_CURRENT_MIN 15
